...
wget https://dl-ptb.discordapp.net/apps/linux/${versionnum}/discord-ptb-${versionnum}.tar.gz

# Extract file
tar -xvzf discord-ptb-${versionnum}.tar.gz

# Delete archive
rm -rf discord-ptb-${versionnum}.tar.gz
